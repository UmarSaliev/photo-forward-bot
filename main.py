...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    "/task — 📌 Генерирует новую задачу по математике\n"
    "/definition — 📘 Даёт определение математического термина\n"
    "/formula — 📐 Даёт формулу по указанной теме\n"
    "/theorem — 📏 Объясняет математическую теорему\n"
    "/check — 🔍 Проверяет и решает текстовую или фотозадачу с помощью AI")
